    ...
    >
      <Box
        ...
        sx={{
          ...
          height: 1,
          borderRadius: '50%',
          boxShadow: (theme) => `0px -2px 4px 0px ${theme.palette[color].main} inset`,
          background: (theme) =>
            `linear-gradient(135deg, ${theme.palette[color].lighter}, ${theme.palette[color].light})`,
          [stylesMode.dark]: {
            boxShadow: (theme) => `0px -2px 4px 0px ${theme.palette[color].dark} inset`,
          },
          ...sx,
        }}
      />

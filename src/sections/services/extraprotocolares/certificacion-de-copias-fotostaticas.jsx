...
export default function CertificacionCopiasFotostaticasView() {

    return (
        <>
            <ComponentHero
                title="Certificación de Copias Fotostáticas"
                subtitle="Obtén copias certificadas con plena validez legal, verificadas y autenticadas por notario."
            />
